...
namespace TPie_Plus.Config
{
    public class IconBrowserWindow : Window
    {
        ...
        {
            if (!ImGui.BeginTabBar("##TPie_Plus_Icon_Browser_TabBar"))
            {
                return;
            }

            // General
            if (ImGui.BeginTabItem("Browse ##TPie_Plus_Icon_Browse_Tab"))
            {
                DrawBrowseTab();
                ImGui.EndTabItem();
            }
            ...
            // Rings
            if (ImGui.BeginTabItem("Search ##TPie_Plus_Icon_Search_Tab"))
            {
                DrawSearchTab();
                ImGui.EndTabItem();
            }
