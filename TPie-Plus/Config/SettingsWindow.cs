...
namespace TPie_Plus.Config
{
    internal class SettingsWindow : Window
    {
        ...
        public SettingsWindow(string name) : base(name)
        {
            ...
            // This controls the window size for all inherited elements.
        ...
        public override void Draw()
        {
            ...
            if (!ImGui.BeginTabBar("##TPie_Plus_Settings_TabBar"))
            {
                return;
            }

            // General
            if (ImGui.BeginTabItem("General ##TPie_Plus_Settings"))
            {
                DrawGeneralTab();
                ImGui.EndTabItem();
            }
            ...
            if (ImGui.BeginTabItem("Global Border Settings ##TPie_Plus_Settings"))
            {
            ...
            // Rings
            if (ImGui.BeginTabItem("Rings ##TPie_Plus_Settings"))
            {
                DrawRingsTab();
                ImGui.EndTabItem();
            }
        ...
        private void DrawGeneralTab()
        {
            ...
            ImGui.BeginChild("##Keybinds", new Vector2(384 * _scale, 64 * _scale), true);
            {
                ...
                DrawHelper.SetTooltip("When enabled, TPie+ wont prevent the game from receiving a key press assigned for a ring.");
                ...
                DrawHelper.SetTooltip("When enabled, pressing the Escape key while a ring with a toggle keybind is opened will immediately close it.");
            }
            ImGui.EndChild();
        ...
        private void DrawRingsTab()
        {
            ...
            ImGui.BeginChild("##Options", new Vector2(384 * _scale, 40 * _scale), true);
            {
                ...
                if (ImGui.Button(FontAwesomeIcon.Plus.ToIconString()))
                {
                    ...
                    Ring newRing = new Ring($"Ring{Rings.Count + 1}", Vector4.One, new KeyBind([0]), 150f, 40);
